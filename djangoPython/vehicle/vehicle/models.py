...
class Mechanic(models.Model):
    ...
    nic_pic= models.ImageField(upload_to='nic_pic/MechanicProfilePic/',null=True,blank=True)
    address = models.CharField(max_length=40)
    mobile = models.CharField(max_length=20,null=False)
...
class MechanicForm(forms.Form):
    nic_pic = forms.ImageField(widget=forms.FileInput(attrs={'class': 'form-control', 'placeholder': 'NIC Pic'}))